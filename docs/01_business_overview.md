...
**Sales leadership needs to know where not to trust the output.**
...
| **LLM-generated email is a draft** | The outreach email is generated by Claude Sonnet (or Groq llama-3.3-70b). It uses real data, but tone, accuracy of claims, and CTA should be reviewed before sending. | Always read the email before sending. The pain point evidence is real; the language is a starting point. |
